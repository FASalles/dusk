    ...
    public function testClickButtonAndAgree()
{
    $this->browse(function (Browser $browser) {
        $browser->visit('/')
                ...
                ->assertVisible('@modal-button') // Verifica se o botão está visível
//                ->click('@text-button') // Clica no botão para mostrar o texto
                ->click('@modal-button') // Clica no botão para abrir o modal
